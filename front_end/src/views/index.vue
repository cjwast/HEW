    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 text-left">
          ...
          <h2 class="py-2">Art Shows in: <u>Mexico City</u> <i class="fas fa-caret-down text-muted"></i></h2>
        </div>
        <div class="col-md-6 align-text-bottom text-right">
            <p class="align-bottom mt-4">Sort by: <u>Application Deadline</u> <i class="fas fa-caret-down text-muted"></i></p>
