            ...
            <div id="accordion">
                ...
                <div>
                  <div class="card-body" id="headingOne">
                    ...
                    <div class="row d-flex justify-content-between py-3 px-3">
                      <h6><a href="Website" target="_blank" class=""><i class="fas fa-external-link-square-alt mr-1"></i>Website</a></h6>
                      <h6><a href="Website" target="_blank" class=""><i class="fas fa-external-link-square-alt mr-1"></i>Instagram</a></h6>  
                      <h6><a href="Website" target="_blank" class=""><i class="fas fa-external-link-square-alt mr-1"></i>Statement</a></h6>
                      <h6><a href="Website" target="_blank" class=""><i class="fas fa-external-link-square-alt mr-1"></i>Submitted Images</a></h6>
                    </div>
                    <div class="">
                      <a href="" class="text-muted" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                ...
                <div>
                    <div class="card-body" id="headingOne">
                      ...
                      <div class="">
                        <a href="" class="text-muted" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
                          Read Full Submission
                          </a>
                      </div>
                    </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Thanks for your submission">
              </div>
              <div class="form-group">
