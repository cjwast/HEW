            ...
            <div class="card mb-5">
              ...
              <form>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Dropbox, Google Drive, etc...">
                  </div>
                  <div class="form-group">
                      <label for="exampleFormControlTextarea1">Link to Supplemental Material</label>
                      <input type="text" class="form-control" id="exampleFormControlInput1" placeholder="Artist Statement PDF, etc...">
                    </div>
                  <div class="form-group">
